...
export default function BookingPage() {
  ...
  const calculateTotalPrice = () => {
    ...
    const tjsFee = selectedSeats.length ? 3 : 0;
  ...
  return (
    <Container size={"xl"} className="mt-5 md:mt-10 px-2 md:px-10">
      ...
      <div className="grid grid-cols-12 gap-10 mt-5">
        <div className="col-span-12 md:col-span-8 bg-white w-full">
        ...
        <div className="col-span-12 md:col-span-4 h-fit">
          <div className="bg-white rounded-lg p-4 shadow-[0_0_3px_rgba(0,0,0,0.1)]">
            ...
            <div className="flex items-center justify-between">
              ...
              <Text className="text-dark-blue">3 TJS</Text>
            </div>
            <div className="mt-4">
              <Checkbox
                label={
